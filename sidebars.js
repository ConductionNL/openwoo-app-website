...
module.exports = {
  tutorialSidebar: [
    ...
    /* Releases — auto-populated by .github/workflows/release-notes-sync.yml,
       a scheduled poller that reads each tracked component's public
       releases-API every 30 minutes. No cross-repo secrets needed
       (Conduction post-"github has been hacked" policy bans PATs on
       hosted runners). Sub-folder per component, one markdown per
       stable tag. */
    {
      type: 'category',
      label: 'Releases',
      link: {
        type: 'generated-index',
        description: 'Release-aankondigingen per stack-component. Automatisch bijgewerkt door een scheduled poller — zie release-notes-sync.yml.',
      },
